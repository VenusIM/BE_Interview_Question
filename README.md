...
- **DI** <br/>
  - xml을 통한 설정, java-config, annotation 등을 통해서 Bean 등록이 가능하며, Application 구동시 Singleton으로 생성해 놓습니다.
...
- **SpringBoot** <br/>
  ...
  - 내장 웹서버 제공합니다.
  - 실행 가능한 jar로 개발 가능합니다.
  - AutoConfig를 통해 설정을 자동화 할 수 있습니다.
